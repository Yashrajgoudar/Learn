namespace CodingI.SolveQuestions.DynamicProgramming.Practice
{
    /*
        ...
        110
     */
    public class _4_NinjasTraining
    {
        public static int Train(int[,] mat,int day,int last)
        {
            if (day == 0)
            {
                int maxi = 0;
            ...
            for(int i = 0; i < 3; i++)
            {
                if (i != last)
                {
                    int point = mat[day, i] + Train(mat, day - 1, i);
        ...
        public static void main()
        {
            ...
            Console.WriteLine(Train(mat, mat.GetLength(0) - 1, 3));
        }
    }
}
